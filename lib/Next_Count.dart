                ...
                children: [
                  ...
                  padding: EdgeInsets.fromLTRB(45, 20, 20, 0),
                    child: Row(
                      ...
                      children: [
                        TextButton(onPressed: addSecond1, child: const Text('5m'),style: TextButton.styleFrom(primary: Colors.black)),
                        TextButton(onPressed: addSecond2, child: const Text('10m'),style: TextButton.styleFrom(primary: Colors.black)),
                        TextButton(onPressed: addSecond3, child: const Text('15m'),style: TextButton.styleFrom(primary: Colors.black)),
                        TextButton(onPressed: addSecond4, child: const Text('20m'),style: TextButton.styleFrom(primary: Colors.black)),
                        TextButton(onPressed: addSecond5, child: const Text('25m'),style: TextButton.styleFrom(primary: Colors.black)),
                        SizedBox(height: 48,),
                      ],
                    ),
                ),
                     ...
                     Container(
                       child: Padding(
                         ...
                         child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                           children: [
                              TextButton(onPressed: addSecond6, child: const Text('30m'),style: TextButton.styleFrom(primary: Colors.black)),
                              TextButton(onPressed: addSecond7, child: const Text('35m'),style: TextButton.styleFrom(primary: Colors.black)),
                              TextButton(onPressed: addSecond8, child: const Text('40m'),style: TextButton.styleFrom(primary: Colors.black)),
                              TextButton(onPressed: addSecond9, child: const Text('45m'),style: TextButton.styleFrom(primary: Colors.black)),
                               SizedBox(height: 48,),
                           ],
                         ),
                       ),
